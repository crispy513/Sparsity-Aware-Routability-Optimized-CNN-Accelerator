...
#define DLA_SPARSE_BITMAP_INDEX_OFFSET 0x34
#define DLA_SPARSE_BITMAP_WDATA_OFFSET 0x38
#define DLA_SPARSE_BITMAP_RDATA_OFFSET 0x3c
#define DLA_SPARSE_LEN_INDEX_OFFSET    0x40
#define DLA_SPARSE_LEN_WDATA_OFFSET    0x44
#define DLA_SPARSE_LEN_RDATA_OFFSET    0x48
#define DLA_SPARSE_CTRL_OFFSET         0x4c

#define DLA_SPARSE_BLOCK_SIZE     8u
#define DLA_SPARSE_BMAP_ADDR_BITS 15u
#define DLA_SPARSE_BMAP_ADDR_MASK ((1u << DLA_SPARSE_BMAP_ADDR_BITS) - 1u)
#define DLA_SPARSE_INDEX_SEL_SHIFT 16u

#define DLA_SPARSE_SEL_IFMAP  0u
#define DLA_SPARSE_SEL_FILTER 1u
#define DLA_SPARSE_SEL_IPSUM  2u
#define DLA_SPARSE_SEL_OPSUM  3u
...
/**
 * @brief Provide API for Runtime
 * @param host_ptr Real data address
 * @param size Data size
 * @return Handle for hardware (uint32_t)
 */
uint32_t mmu_map(void* host_ptr, size_t size);

/**
 * @brief Release mapping
 */
void mmu_unmap(uint32_t device_addr);
